...
function addCharacters() {
  ...
  miku.setAttribute("position", "0 2 -10"); 
  miku.setAttribute("rotation", "0 180 0");
  miku.setAttribute('visible', 'true');
  miku.setAttribute('dynamic-body', 'shape: box;'); 
  ...
  luffy.setAttribute("position", "0 2 -17");  
  luffy.setAttribute("rotation", "0 0 0");
  luffy.setAttribute('visible', 'true');
  luffy.setAttribute('dynamic-body', 'shape: box;'); 
  ...
  fstud1.setAttribute("position", "-17 2 -1");  
  fstud1.setAttribute("rotation", "0 180 0");
  fstud1.setAttribute('visible', 'true');
  fstud1.setAttribute('dynamic-body', 'shape: box;'); 
...
function startCutscene() {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      classroomFloor.setAttribute("geometry", "primitive: plane; width: 40; height: 40");
      classroomFloor.setAttribute("position", "0 0 -10");
      classroomFloor.setAttribute("rotation", "-90 0 0");
      classroomFloor.setAttribute("material", "color: #333; opacity: 0.0; transparent: true");
      ...
      spotLight.setAttribute("light", "type: spot; angle: 45; color: #FFF; intensity: 1.0; castShadow: true");
